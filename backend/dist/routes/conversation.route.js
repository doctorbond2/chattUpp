...
import { createNewConvoController, getConversations, deactivateConversation, activateConversation, deleteConvoAndMessages, getOneConversation, } from '../controllers/conversation.controller.js';
const { conv_route_CREATE, conv_route_GET_LIST, conv_route_DEACTIVATE, conv_route_ACTIVATE, conv_route_DELETE_ONE_CONVERSATION, conv_route_GET_ONE, } = process.env;
