...
import { createUser, getUserProfile, getUserList, updateUserController, detailedUserController, addFriendController, removeFriendController, } from '../controllers/user.controller.js';
import { verifyAccessTokenMiddleware as vToken, VerifyKeyMiddleware as vKey, } from '../middleware/auth.middleware.js';
const { user_route_CREATE, user_route_ID_PROFILE, user_route_LIST, user_route_UPDATE_ONE_ID, user_route_PROFILE_DETAILS, user_route_ADD_FRIEND, user_route_DELETE_FRIEND, } = process.env;
